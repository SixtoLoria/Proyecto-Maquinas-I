...
print(f"Energía anual consumida en kWh:                {energia_anual_kWh:.2f}")
print(f"Potencia anual consumida en KW:                {potencia_anual_kW:.2f}")
...
print("\nPERDIDAS EN ENERGIA Y POTENCIA")
...
print("\nCOSTO DE LAS PERDIDAS + ENERGIA CONSUMIDA")
